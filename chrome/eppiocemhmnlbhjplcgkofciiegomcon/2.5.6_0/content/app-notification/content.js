...
/******/ 	return __webpack_require__(__webpack_require__.s = "./app/content/app-notification/content.ts");
/******/ })
/************************************************************************/
/******/ ({
...
/***/ "./app/content/app-notification/ContentNotificationService.ts":
/*!********************************************************************!*\
  !*** ./app/content/app-notification/ContentNotificationService.ts ***!
  \********************************************************************/
/*! no static exports found */
...
Object.defineProperty(exports, "__esModule", { value: true });
exports.ContentNotificationService = void 0;
const NotificationContentIn_1 = __webpack_require__(/*! ../../bg/modules/notification-module/NotificationContentIn */ "./app/bg/modules/notification-module/NotificationContentIn.ts");
const NotificationTypes_1 = __webpack_require__(/*! ./NotificationTypes */ "./app/content/app-notification/NotificationTypes.ts");
class ContentNotificationService {
    constructor(dispatcher) {
        this.dispatcher = dispatcher;
        this.showing = false;
        this.dispatcher.on(NotificationContentIn_1.NotificationContentIn.NOTIFICATION_SHOW, (message) => {
            console.log(`Received notification`);
            this.show(message.data.notification).then();
        });
        const onMessage = (msg) => {
            const message = msg.data;
            if (message.type === NotificationTypes_1.MessageType.IFRAME_OUT) {
                const handlers = {
                    [NotificationTypes_1.IframeEventsOut.NOTIFICATION_HIDE]: this.hide.bind(this),
                    [NotificationTypes_1.IframeEventsOut.BUTTON_CLICKED]: this.onButtonClicked.bind(this),
                    [NotificationTypes_1.IframeEventsOut.DATA_HANDLED]: this.dataHandled.bind(this),
                };
                if (handlers[message.event]) {
    ...
    show(notification) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            this.emit(NotificationTypes_1.IframeEventsIn.NOTIFICATION_DATA, notification);
        });
    }
    hide() {
        this.showing = false;
        this.iframe.style.right = '-1600px';
    }
    inject() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return new Promise(resolve => {
                ...
                this.iframe.style.transition = 'right 1s';
                this.iframe.style.width = '453px';
                this.iframe.style.height = '165px';
                this.iframe.style.position = 'fixed';
                this.iframe.style.top = '16px';
                this.iframe.style.right = '-1600px';
                this.iframe.style.zIndex = '9999999999';
                this.iframe.style.borderRadius = '6px';
                this.iframe.style.boxShadow = '0 2px 8px 0 rgba(0, 0, 0, 0.3)';
                this.iframe.style.backgroundColor = '#ffffff';
                this.iframe.style.border = 'solid 1px #d7d7d7';
                this.iframe.src = chrome.extension.getURL('content/app-notification/app-iframe/index.html');
                this.iframe.id = 'urban_app_iframe';
    ...
    emit(event, data) {
        const message = {
            data,
            event,
            type: NotificationTypes_1.MessageType.IFRAME_IN,
        };
...
exports.ContentNotificationService = ContentNotificationService;


/***/ }),

/***/ "./app/content/app-notification/NotificationTypes.ts":
/*!***********************************************************!*\
  !*** ./app/content/app-notification/NotificationTypes.ts ***!
  \***********************************************************/
/*! no static exports found */
...
Object.defineProperty(exports, "__esModule", { value: true });
exports.IframeEventsIn = exports.IframeEventsOut = exports.MessageType = void 0;
var MessageType;
(function (MessageType) {
    MessageType["IFRAME_IN"] = "NOTIFICATION_IFRAME_IN";
    MessageType["IFRAME_OUT"] = "NOTIFICATION_IFRAME_OUT";
    MessageType["CONTENT_IN"] = "NOTIFICATION_CONTENT_IN";
    MessageType["CONTENT_OUT"] = "NOTIFICATION_CONTENT_OUT";
})(MessageType = exports.MessageType || (exports.MessageType = {}));
var IframeEventsOut;
(function (IframeEventsOut) {
    IframeEventsOut["NOTIFICATION_HIDE"] = "NOTIFICATION_HIDE";
    IframeEventsOut["BUTTON_CLICKED"] = "NOTIFICATION_BUTTON_CLICKED";
    IframeEventsOut["DATA_HANDLED"] = "NOTIFICATION_DATA_HANDLED";
})(IframeEventsOut = exports.IframeEventsOut || (exports.IframeEventsOut = {}));
var IframeEventsIn;
(function (IframeEventsIn) {
    IframeEventsIn["NOTIFICATION_DATA"] = "NOTIFICATION_DATA";
})(IframeEventsIn = exports.IframeEventsIn || (exports.IframeEventsIn = {}));


/***/ }),

/***/ "./app/content/app-notification/content.ts":
/*!*************************************************!*\
  !*** ./app/content/app-notification/content.ts ***!
  \*************************************************/
/*! no static exports found */
...
Object.defineProperty(exports, "__esModule", { value: true });
const ContentNotificationService_1 = __webpack_require__(/*! ./ContentNotificationService */ "./app/content/app-notification/ContentNotificationService.ts");
...
const notificationService = new ContentNotificationService_1.ContentNotificationService(dispatcher);
